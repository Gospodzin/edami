...
//	Point p2(attrs2);
//
//	double dist = preDeConMeasures::euclideanDistance(&p1,&p2);
//
...
//
//	auto epsNeighborhood = bruteForceEpsNeighborhoodCalc(2.0, &thePoint, otherPoints, preDeConMeasures::euclideanDistance);
//
