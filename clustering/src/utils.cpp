...
vector<Point> utils::loadDataMichal(std::string fileName)
{
	//TODO mocked
	vector<Point> data;
	// task 3. from the 14L MockTestII :D
	data.push_back(Point(vector<double> { 1, 2}));
	data.push_back(Point(vector<double> { 2, 1}));
	data.push_back(Point(vector<double> { 2, 2}));
	data.push_back(Point(vector<double> { 3, 2}));
	data.push_back(Point(vector<double> { 3, 3}));
	data.push_back(Point(vector<double> { 3, 5}));
	data.push_back(Point(vector<double> { 4, 2}));
	data.push_back(Point(vector<double> { 4, 4}));
	data.push_back(Point(vector<double> { 4, 5}));
	data.push_back(Point(vector<double> { 8, 5}));
	data.push_back(Point(vector<double> { 8, 6}));
	data.push_back(Point(vector<double> { 9, 5}));
	data.push_back(Point(vector<double> { 10, 4}));
	data.push_back(Point(vector<double> { 10, 2}));
	data.push_back(Point(vector<double> { 11, 3}));
	return data;
}
